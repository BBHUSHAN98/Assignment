...
import { Button, Input, Select, RadioGroup, Radio, FormLabel, RangeSlider } from '@chakra-ui/react';
import {
  Modal,
  ModalOverlay,
  ModalContent,
...
const AddProduct = () => {
  ...
  return (
    <>
      ...
      <Button my={4} data-cy="add-product-button" colorScheme='teal' size='md'   onClick={() => {
